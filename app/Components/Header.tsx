...
export default function Header() {
  ...
  return (
    <header className="flex justify-between items-center px-2 md:px-14 py-5 h-[75px]">
      ...
      <nav className={`${isNav ? "z-[10] fixed left-[-10px] w-[250px] top-[20%] min-h-[400px] bg-blue-800 text-white flex flex-col items-center gap-3 sm:gap-6 py-10 rounded-md" : "hidden sm:flex gap-8"}`} onClick={() => setIsNav(false)} ref={navRef}>
